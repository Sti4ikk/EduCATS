...
namespace EduCATS.Pages.Settings.About.Views
{
	public class AboutPageView : ContentPage
	{
		...
		{
			var color = Color.FromArgb(Theme.Current.AboutTextColor);
		...
		Label createContributorLabel(string localizedKey, bool bold = false)
		{
			return new Label
			{
				...
				TextColor = Color.FromArgb(Theme.Current.AboutTextColor)
			};
		}
		...
		Button createButton(string text, string commandProperty)
		{
			var button = new Button
			{
				...
				TextColor = Color.FromArgb(Theme.Current.AboutButtonTextColor),
				VerticalOptions = LayoutOptions.Start,
				BackgroundColor = Color.FromArgb(Theme.Current.AboutButtonBackgroundColor)
			};
